 ...
 */
class getStaticPagesControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\StaticPagesController' shared autowired service.
     *
     * @return \App\Controller\StaticPagesController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/StaticPagesController.php';

        $container->services['App\\Controller\\StaticPagesController'] = $instance = new \App\Controller\StaticPagesController();
        ...
        ]))->withContext('App\\Controller\\StaticPagesController', $container));
